...
def align_image_record(image_record, input_root=IN_IMAGE_ROOT, output_root=OUT_ALIGN_ROOT, new_size=NEW_SIZE):
    ...
    in_image_fpath = os.path.join(input_root, image_record.ms1m_id, image_record.fname)
    ...
    if outRgb is not None:
        ...
        out_image_dirname = os.path.join(output_root, image_record.ms1m_id)
